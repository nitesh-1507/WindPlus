...
RcppExport SEXP _WindPlus_matchcov(SEXP refSEXP, SEXP objSEXP, SEXP thresSEXP, SEXP circ_posSEXP, SEXP posSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(matchcov(ref, obj, thres, circ_pos, pos));

...
The package aims at unveiling a technique called covariate matching, which takes in different data sets and returns data sets whose feature values exhibit similar characteristics or similar distribution.
...
* cov - position or column number of non circular covariates 
* weight - threshold to skim out most similar observation
* cov_circ - position or column number of circular covariates 

2. Matching two data sets
